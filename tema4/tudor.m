...
T=[300 400 500 600]; % temperatura absoluta a gazului [K]

m0=[222 128 121]*ua; % masa absoluta a moleculei de He, N2, si CO2 [kg]
...
title('Dependenta de temperatura a functiei Maxwell pentru diclorodifluorometan')
...
legend('radon','acid iodhidric','diclorodifluorometan')
...
v1=0; v2=406; % limitele de integrare [m/s]

prob=integral(@(v)Maxwell(v,kB,m0(3),T(1)),v1,v2); % integreaza intre v1 si v2

afis=['Probabilitatea ca o molecula de azot la 600 K sa aiba viteza cuprinsa intre ',...
